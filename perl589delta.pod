...
Compile support added for RISC OS 
...
C<[[:xxxxx:]]> and C<\p{IsXxxxx}> matches.

L<perlhack> documentation extensively improved by Jarkko Hietaniemi and others.

=head1 Changes to Existing Documentation

L<perltdo> was, of course, extensively modified; with the notable marking of the srlcpy/strcat 
...
Now checking if localtime_r needs tzset
