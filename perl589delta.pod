...
Avoid building man pages for extensions even if the F<Makefile.PL> forgets to
specify it.
...
F<uupacktool.pl> has been updated for VMS and is now used during the VMS build.
