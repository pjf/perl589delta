...
C<AutoLoader> upgraded to version 5.64
...
C<Math::Complex> upgraded to version 1.48

=item *

C<Math::Trig> upgraded to version 1.13

=item *

C<Net::Ping> upgraded to version 2.34.

=item *

C<PathToos> upgraded to version 3.25
