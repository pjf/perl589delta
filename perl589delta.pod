...
C<B::Debug> upgraded to version 1.03
...
C<Data::Dumper> upgraded to version 2.121_11
...
C<File::Spec>, C<File::Spec::Epoc>, C<File::Spec::Mac>, C<File::Spec::Functions>
C<File::Spec::Unix>, C<File::Spec::VMS>, C<File::Spec::Win32> upgraded to version
3.2701 with improved handling of bad arguments and some platform specific
improvements (Including for VMS and Cygwin)
...
C<PathTools> upgraded to version 3.22
...
C<Math::Complex> upgraded to version 1.52 [33293]
...
C<Time::HiRes> upgraded to version 1.9715 with various build improvements and minor
...
C<h2ph> generates correct correct code for C<#if defined A || defined B> now (perl #39130)
...
L<perlfunc> documentation is fixed in section C<caller> and C<pop>, added
example of C<gethostbyname>, and also better wording in C<prototype> and
C<split>.

L<perlcheat> is updated with a better details on C<\w>, C<\d>, and C<\s>.
