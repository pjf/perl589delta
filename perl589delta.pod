...
Width and precision in sprintf didn't handle wide characters correctly (30058).
...
not available on the current platform (25987).
...
the current codepage. The C<PATH> environment variable now also uses ANSI
